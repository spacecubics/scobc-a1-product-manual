...
| 24| GND| Power| -| 電源(GND)
| 25| UIO3_00| Inout| VDD_3V3_SYS / VDD_3V3_IOfootnoteref:[1, ハードウェアオプションによって電源ドメインが異なる。fuzzy:*ハードウェアオプションと IOの接続関係[fuzzy:*ハードウェアオプションと IOの接続関係]参照]| User IO3 Bit 0信号、PIC16LF877の RD4/PSP4に接続。ハードウェアオプションで FPGAの IO_L23P_T3_12 (pin: Y15)に接続を変更する事が可能
| 26| UIO3_01| Inout| VDD_3V3_SYS / VDD_3V3_IOfootnoteref:[1]| User IO3 Bit 1信号、PIC16LF877の RD5/PSP5に接続。ハードウェアオプションで FPGAの IO_L23N_T3_12 (pin: AA15)に接続を変更する事が可能
| 27| UIO3_02| Inout| VDD_3V3_SYS / VDD_3V3_IOfootnoteref:[1]| User IO3 Bit 2信号、PIC16LF877の RD6/PSP6に接続。ハードウェアオプションで FPGAの IO_L24P_T3_12 (pin: W14)に接続を変更する事が可能
| 28| UIO4_00| Input| VDD_3V3_IO| User IO4 Bit 0信号、FPGAの IO_L22P_T3_12 (pin: AB16)に接続
| 29| GND| Power| -| 電源(GND)
| 30| TRCH_UART_TX| Output| VDD_3V3_SYS / VDD_3V3_IOfootnoteref:[1]| TRCH UART TX信号、PIC16LF877の RC6/TX/CKに接続。ハードウェアオプションで FPGAの IO_L24N_T3_12 (pin: W15)に接続を変更する事が可能
|====
...
| 31| TRCH_UART_RX| Input| VDD_3V3_SYS / VDD_3V3_IOfootnoteref:[1]| TRCH UART RX信号、PIC16LF877の RC7/RX/DTに接続。ハードウェアオプションで FPGAの IO_L1N_T0_12 (pin: AE26)に接続を変更する事が可能
...
| 36| WDOG_OUT| Output| VDD_3V3_SYS / VDD_3V3_IOfootnoteref:[1]| Watchdog出力信号、PIC16LF877の RE0/AN5/RDに接続。ハードウェアオプションで FPGAの IO_L16N_T2_12 (pin: AF18)に接続を変更する事が可能
...
[fn:hwopt] ハードウェアオプションによって電源ドメインが異なる。fuzzy:*ハードウェアオプションと IOの接続関係[fuzzy:*ハードウェアオプションと IOの接続関係]参照
