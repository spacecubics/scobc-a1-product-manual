...
image::scobc-a1-jp:ROOT:user_io_vdd33.png[scaledwidth=100%]

When using User IO at 3.3 V or when the IO Board consumes less than 0.3 A, VDD_3V3 can serve as the power supply.

image::scobc-a1-jp:ROOT:user_io_vdd16.png[scaledwidth=100%]
...
image::scobc-a1-jp:ROOT:mplab_pickit4_connect.png[scaledwidth=100%]
...
image::scobc-a1-jp:ROOT:platform_cable_connect.png[scaledwidth=100%]
