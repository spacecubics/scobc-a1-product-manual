...
image::scobc-a1-jp:ROOT:power_on_timing.png[scaledwidth=100%]
...
image::scobc-a1-jp:ROOT:watchdog_system.png[scaledwidth=100%]
...
image::scobc-a1-jp:ROOT:system_reboot.png[scaledwidth=100%]
