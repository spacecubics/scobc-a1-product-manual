...
image::scobc-a1-ja:ROOT:power_on_timing.png[scaledwidth=100%]
...
image::scobc-a1-ja:ROOT:watchdog_system.png[scaledwidth=100%]
...
image::scobc-a1-ja:ROOT:system_reboot.png[scaledwidth=100%]
